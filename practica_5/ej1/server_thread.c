...
int main(int argc, char *argv[])
{
    ...
    while (1)
    {
        // tengo que allocar un nuevo newsockfd por cada thread porque cuando un
        // thread termina, lo cierra y caga a los demas (el thread usa la dirección del socket)
